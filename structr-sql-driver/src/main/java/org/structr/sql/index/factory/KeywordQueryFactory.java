 ...
 */
package org.structr.sql.index.factory;
...
import org.structr.sql.SQLQuery;
import org.structr.sql.index.predicate.NullPredicate;
import org.structr.sql.index.predicate.ValuePredicate;
import org.structr.sql.index.predicate.StringContainsPredicate;

public class KeywordQueryFactory extends AbstractQueryFactory<SQLQuery> {
	...
	@Override
	public boolean createQuery(final QueryPredicate predicate, final SQLQuery query, final boolean isFirst) {
