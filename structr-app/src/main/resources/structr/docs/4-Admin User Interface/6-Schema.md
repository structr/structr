...
![Relationship Created](schema_relationship-created.png)
...
1. Create data objects in the [Data](8-Data.md) management section
2. Build pages that display your schema data in [Pages](2-Pages.md)
3. Configure appropriate [Security](5-Security.md) permissions
4. Monitor schema performance through the [Dashboard](1-Dashboard.md)
