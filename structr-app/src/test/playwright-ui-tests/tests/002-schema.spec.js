...
test('schema', async ({ page }) => {
  ...
  await page.waitForTimeout(1000);
  await page.screenshot({ path: 'schema.png' });
  ...
  await page.waitForTimeout(1000);
  await page.screenshot({ path: 'schema_create-type_Project.png' });
  ...
  await page.waitForTimeout(1000);
  await page.screenshot({ path: 'schema_property-added_projectId.png' });
  await page.getByRole('button', { name: 'Save All', exact: true }).click();
  await page.waitForTimeout(1000);
  await page.getByRole('button', { name: 'Close', exact: true }).click();
  await page.waitForTimeout(1000);
  await page.screenshot({ path: 'schema_type-created_Project.png' });
  ...
  await page.getByRole('button', { name: 'Save and Close' }).click();
  await page.waitForTimeout(500);
  await page.screenshot({ path: 'schema_added-Milestone-properties.png' });
  await page.getByRole('button', { name: 'Close', exact: true }).click();
  await page.waitForTimeout(1000);
  await page.screenshot({ path: 'schema_type-created_Milestone.png' });
  ...
  await page.getByRole('button', { name: 'Create', exact: true }).click();
  await page.screenshot({ path: 'schema_relationship-project-milestone-created.png' });
  await page.getByRole('button', { name: 'Close', exact: true }).click();
  ...
  await page.getByRole('button', { name: 'Save and Close' }).click();
  await page.waitForTimeout(500);
  await page.screenshot({ path: 'schema_added-Task-properties.png' });
  await page.getByRole('button', { name: 'Close', exact: true }).click();
  await page.waitForTimeout(1000);
  await page.screenshot({ path: 'schema_type-created_Project.png' });
  ...
  await page.getByRole('button', { name: 'Create', exact: true }).click();
  await page.screenshot({ path: 'schema_relationship-project-task-created.png' });
  await page.getByRole('button', { name: 'Close', exact: true }).click();
