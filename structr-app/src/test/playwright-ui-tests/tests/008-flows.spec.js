...
test('flows', async ({ page }) => {
  ...
  await page.waitForTimeout(1000);
  await page.screenshot({path: 'flows.png'});
  ...
  await page.waitForTimeout(1000);
  await page.screenshot({path: 'flows_created-flow.png'});
  ...
  await page.waitForTimeout(1000);
  await page.screenshot({path: 'flows_added-type-query.png'});
  ...
  await page.screenshot({path: 'flows_created-return-node.png'});
  ...
  await page.mouse.up();
  await page.waitForTimeout(500);
  await page.screenshot({path: 'flows_arranged-nodes.png'});
  ...
  await page.mouse.up();
  await page.waitForTimeout(500);
  await page.screenshot({path: 'flows_connected-nodes.png'});
