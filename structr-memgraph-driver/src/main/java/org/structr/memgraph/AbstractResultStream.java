...
abstract class AbstractResultStream<T> implements Iterable<T> {
	...
	protected abstract Iterable<T> fetchData(final MemgraphDatabaseService db, final String statement, final Map<String, Object> data);

	public AbstractResultStream(final MemgraphDatabaseService db, final CypherQuery query) {
