...
import org.structr.knowledge.iso25964.Note;
import org.structr.knowledge.iso25964.ThesaurusConcept;

public class NoterefersToThesaurusConcept extends ManyToMany<Note, ThesaurusConcept> {

        @Override
        public Class<Note> getSourceType() {
                return Note.class;
        }
