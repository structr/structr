...
public class ThesaurusConcepthasNonPreferredLabelSimpleNonPreferredTerm extends OneToMany<ThesaurusConcept, SimpleNonPreferredTerm> {
	...
	@Override
	public Class<SimpleNonPreferredTerm> getTargetType() {
		return SimpleNonPreferredTerm.class;
	}

	@Override
	public String name() {
		return "hasNonPreferredLabel";
	}
}
