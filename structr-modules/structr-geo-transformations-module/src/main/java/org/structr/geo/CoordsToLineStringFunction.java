...
public class CoordsToLineStringFunction extends GeoFunction {

	private static final Logger logger                                   = LoggerFactory.getLogger(CoordsToLineStringFunction.class.getName());
		...
		try {
			...
			if (sources[0] instanceof List) {
				...
				try {
					...
					final LineString lineString = factory.createLineString(coordinates.toCoordinateArray());
