 ...
 */
package org.structr.csv.common;
 ...
 *
 */
public class StructrCsvModuleTest {

	private static final Logger logger = LoggerFactory.getLogger(StructrCsvModuleTest.class.getName());
