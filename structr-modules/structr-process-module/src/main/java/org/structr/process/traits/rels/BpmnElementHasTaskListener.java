...
/**
 * BpmnElement -[HAS_TASK_LISTENER]-> BpmnTaskListener.
 *
 * Connects a BPMN userTask (or any activity) to its declared lifecycle
 * listeners (created / assigned / claimed / available / declined /
 * completed / cancelled). Subordinate to the element: deleting the element
 * cascades to its listeners.
 *
 * Read access propagates with the element, mirroring how performers attach.
 */
public class BpmnElementHasTaskListener extends AbstractRelationshipTraitDefinition implements RelationshipBaseTraitDefinition {
	...
	public BpmnElementHasTaskListener() { super(ProcessTraits.BPMN_ELEMENT_HAS_TASK_LISTENER); }

	@Override public String getSourceType() { return ProcessTraits.BPMN_ELEMENT; }
	@Override public String getTargetType() { return ProcessTraits.BPMN_TASK_LISTENER; }
	@Override public String getRelationshipType() { return "HAS_TASK_LISTENER"; }
