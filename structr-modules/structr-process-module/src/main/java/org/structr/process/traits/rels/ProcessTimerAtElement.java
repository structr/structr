...
/**
 * ProcessTimer -[AT_ELEMENT]-> BpmnElement.
 *
 * Identifies which BPMN element the timer is associated with -- the
 * intermediateCatchEvent for intermediate timers, the boundaryEvent for
 * boundary timers, or the startEvent for timer-start.
 */
public class ProcessTimerAtElement extends AbstractRelationshipTraitDefinition implements RelationshipBaseTraitDefinition {

	public ProcessTimerAtElement() { super(ProcessTraits.PROCESS_TIMER_AT_ELEMENT); }
	...
	@Override public String getRelationshipType() { return "AT_ELEMENT"; }
