...
public class TaskInstanceHasCandidateAssignee extends AbstractRelationshipTraitDefinition implements RelationshipBaseTraitDefinition {
	...
	public TaskInstanceHasCandidateAssignee() { super(ProcessTraits.TASK_INSTANCE_HAS_CANDIDATE_ASSIGNEE); }
	...
	@Override public String getRelationshipType() { return "HAS_CANDIDATE_ASSIGNEE"; }
