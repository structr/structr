...
/**
 * Optional 1:1 link from a BpmnDefinitions to its enclosing BpmnCollaboration.
 * Only present when the BPMN file uses {@code <bpmn:collaboration>}.
 */
public class BpmnDefinitionsHasCollaboration extends AbstractRelationshipTraitDefinition implements RelationshipBaseTraitDefinition {

	public BpmnDefinitionsHasCollaboration() { super(ProcessTraits.BPMN_DEFINITIONS_HAS_COLLABORATION); }

	@Override public String getSourceType() { return ProcessTraits.BPMN_DEFINITIONS; }
	@Override public String getTargetType() { return ProcessTraits.BPMN_COLLABORATION; }
	@Override public String getRelationshipType() { return "HAS_COLLABORATION"; }
