...
public class BpmnLaneHasFlowNode extends AbstractRelationshipTraitDefinition implements RelationshipBaseTraitDefinition {
	...
	public BpmnLaneHasFlowNode() { super(ProcessTraits.BPMN_LANE_HAS_FLOW_NODE); }

	@Override public String getSourceType() { return ProcessTraits.BPMN_LANE; }
	@Override public String getTargetType() { return ProcessTraits.BPMN_ELEMENT; }
	@Override public String getRelationshipType() { return "HAS_FLOW_NODE"; }
