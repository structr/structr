...
/**
 * Connects a BpmnProcess to its direct (top-level) BpmnElement children.
 * Replaces BpmnDefinitionsHasElement once the model split lands.
 * Sub-process containment still uses BpmnElementHasChildElement.
 */
public class BpmnProcessHasElement extends AbstractRelationshipTraitDefinition implements RelationshipBaseTraitDefinition {

	public BpmnProcessHasElement() { super(ProcessTraits.BPMN_PROCESS_HAS_ELEMENT); }
	...
	@Override public String getRelationshipType() { return "HAS_ELEMENT"; }
