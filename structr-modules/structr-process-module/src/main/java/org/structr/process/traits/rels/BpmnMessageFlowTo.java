...
/**
 * BpmnMessageFlow -[TO]-> BpmnElement. Target side of a cross-process
 * message flow. Cascading delete is OFF -- the target element outlives the
 * message flow.
 */
public class BpmnMessageFlowTo extends AbstractRelationshipTraitDefinition implements RelationshipBaseTraitDefinition {

	public BpmnMessageFlowTo() { super(ProcessTraits.BPMN_MESSAGE_FLOW_TO); }
	...
	@Override public String getRelationshipType() { return "TO"; }
