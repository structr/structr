...
/**
 * BpmnMessageFlow -[FROM]-> BpmnElement. Source side of a cross-process
 * message flow. Cascading delete is OFF -- the source element outlives the
 * message flow.
 */
public class BpmnMessageFlowFrom extends AbstractRelationshipTraitDefinition implements RelationshipBaseTraitDefinition {

	public BpmnMessageFlowFrom() { super(ProcessTraits.BPMN_MESSAGE_FLOW_FROM); }

	@Override public String getSourceType() { return ProcessTraits.BPMN_MESSAGE_FLOW; }
	@Override public String getTargetType() { return ProcessTraits.BPMN_ELEMENT; }
	@Override public String getRelationshipType() { return "FROM"; }
