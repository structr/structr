...
/**
 * BpmnCollaboration -[HAS_PARTICIPANT]-> BpmnParticipant. The collaboration
 * owns the participant entries; deleting the collaboration removes them.
 */
public class BpmnCollaborationHasParticipant extends AbstractRelationshipTraitDefinition implements RelationshipBaseTraitDefinition {

	public BpmnCollaborationHasParticipant() { super(ProcessTraits.BPMN_COLLABORATION_HAS_PARTICIPANT); }

	@Override public String getSourceType() { return ProcessTraits.BPMN_COLLABORATION; }
	@Override public String getTargetType() { return ProcessTraits.BPMN_PARTICIPANT; }
	@Override public String getRelationshipType() { return "HAS_PARTICIPANT"; }
