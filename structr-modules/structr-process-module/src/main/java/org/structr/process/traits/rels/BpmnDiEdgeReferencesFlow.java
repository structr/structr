...
public class BpmnDiEdgeReferencesFlow extends AbstractRelationshipTraitDefinition implements RelationshipBaseTraitDefinition {
	...
	public BpmnDiEdgeReferencesFlow() { super(StructrTraits.BPMN_DI_EDGE_REFERENCES_FLOW); }

	@Override public String getSourceType() { return StructrTraits.BPMN_DI_EDGE; }
