...
public class BpmnProcessHasInstancePage extends AbstractRelationshipTraitDefinition implements RelationshipBaseTraitDefinition {
	...
	public BpmnProcessHasInstancePage() { super(ProcessTraits.BPMN_PROCESS_HAS_INSTANCE_PAGE); }

	@Override public String getSourceType() { return ProcessTraits.BPMN_PROCESS; }
	@Override public String getTargetType() { return StructrTraits.PAGE; }
	@Override public String getRelationshipType() { return "HAS_INSTANCE_PAGE"; }
