...
/** ProcessToken -[AT_ELEMENT]-> BpmnElement */
public class ProcessTokenAtElement extends AbstractRelationshipTraitDefinition implements RelationshipBaseTraitDefinition {

	public ProcessTokenAtElement() { super(StructrTraits.PROCESS_TOKEN_AT_ELEMENT); }

	@Override public String getSourceType() { return StructrTraits.PROCESS_TOKEN; }
