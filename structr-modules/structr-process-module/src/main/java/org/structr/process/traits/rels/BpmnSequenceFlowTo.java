...
public class BpmnSequenceFlowTo extends AbstractRelationshipTraitDefinition implements RelationshipBaseTraitDefinition {

	public BpmnSequenceFlowTo() { super(ProcessTraits.BPMN_SEQUENCE_FLOW_TO); }
