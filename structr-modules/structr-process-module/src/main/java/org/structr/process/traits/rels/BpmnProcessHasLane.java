...
public class BpmnProcessHasLane extends AbstractRelationshipTraitDefinition implements RelationshipBaseTraitDefinition {
	...
	public BpmnProcessHasLane() { super(ProcessTraits.BPMN_PROCESS_HAS_LANE); }

	@Override public String getSourceType() { return ProcessTraits.BPMN_PROCESS; }
	@Override public String getTargetType() { return ProcessTraits.BPMN_LANE; }
	@Override public String getRelationshipType() { return "HAS_LANE"; }
