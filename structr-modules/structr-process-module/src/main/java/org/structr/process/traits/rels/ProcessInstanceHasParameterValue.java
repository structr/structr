...
public class ProcessInstanceHasParameterValue extends AbstractRelationshipTraitDefinition implements RelationshipBaseTraitDefinition {
	...
	public ProcessInstanceHasParameterValue() { super(StructrTraits.PROCESS_INSTANCE_HAS_PARAMETER_VALUE); }

	@Override public String getSourceType() { return StructrTraits.PROCESS_INSTANCE; }
	@Override public String getTargetType() { return StructrTraits.PROCESS_PARAMETER_VALUE; }
	@Override public String getRelationshipType() { return "HAS_PARAMETER_VALUE"; }
