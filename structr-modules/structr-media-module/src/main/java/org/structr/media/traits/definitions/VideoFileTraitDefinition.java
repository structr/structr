...
public class VideoFileTraitDefinition extends AbstractNodeTraitDefinition {
	...
	public Map<String, Set<String>> getViews() {
		...
		return Map.of(
			PropertyView.Public,
			newSet(
					CONVERTED_VIDEOS_PROPERTY, "parent", "checksum", POSTER_IMAGE_PROPERTY, IS_VIDEO_PROPERTY, VIDEO_CODEC_NAME_PROPERTY,
			...
			PropertyView.Ui,
			newSet(
					CONVERTED_VIDEOS_PROPERTY, "parent", POSTER_IMAGE_PROPERTY, IS_VIDEO_PROPERTY, VIDEO_CODEC_NAME_PROPERTY,
					VIDEO_CODEC_PROPERTY, PIXEL_FORMAT_PROPERTY, AUDIO_CODEC_NAME_PROPERTY, AUDIO_CODEC_PROPERTY, AUDIO_CHANNELS_PROPERTY,
