...
public class VideoFileTraitDefinition extends AbstractNodeTraitDefinition {
	...
	public Map<String, Set<String>> getViews() {
		...
		return Map.of(
			PropertyView.Public,
			newSet(
					CONVERTED_VIDEOS_PROPERTY, AbstractFileTraitDefinition.PARENT_PROPERTY, "checksum", POSTER_IMAGE_PROPERTY, IS_VIDEO_PROPERTY, VIDEO_CODEC_NAME_PROPERTY,
					VIDEO_CODEC_PROPERTY, PIXEL_FORMAT_PROPERTY, AUDIO_CODEC_NAME_PROPERTY, AUDIO_CODEC_PROPERTY, AUDIO_CHANNELS_PROPERTY,
					SAMPLE_RATE_PROPERTY, DURATION_PROPERTY, WIDTH_PROPERTY, HEIGHT_PROPERTY
			),
			PropertyView.Ui,
			newSet(
					CONVERTED_VIDEOS_PROPERTY, AbstractFileTraitDefinition.PARENT_PROPERTY, POSTER_IMAGE_PROPERTY, IS_VIDEO_PROPERTY, VIDEO_CODEC_NAME_PROPERTY,
					VIDEO_CODEC_PROPERTY, PIXEL_FORMAT_PROPERTY, AUDIO_CODEC_NAME_PROPERTY, AUDIO_CODEC_PROPERTY, AUDIO_CHANNELS_PROPERTY,
					SAMPLE_RATE_PROPERTY, DURATION_PROPERTY, WIDTH_PROPERTY, HEIGHT_PROPERTY, ORIGINAL_VIDEO_PROPERTY
			)
		);
	}
