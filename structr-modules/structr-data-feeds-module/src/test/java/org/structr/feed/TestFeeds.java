...
/**
 */
public class TestFeeds extends StructrDataFeedsModuleTest {
	...
	public void testFeeds() {
		...
		Assert.assertNotNull("Type DataFeed should exist", type);
	...
	public void testRemoteDocument() {
		...
		Assert.assertNotNull("Type RemoteDocument should exist", type);
