...
public class SourcePatternSUBSourcePattern extends OneToMany<SourcePattern, SourcePattern> {
	...
	public static final View uiView = new View(SourcePatternSUBSourcePattern.class, "ui",
