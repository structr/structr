...
public class SourceSiteCONTAINSSourcePage extends OneToMany<SourceSite, SourcePage> {
	...
	public static final View uiView = new View(SourceSiteCONTAINSSourcePage.class, "ui",
		sourceIdProperty, targetIdProperty
	);

	@Override
	public Class<SourceSite> getSourceType() {
		return SourceSite.class;
	}

	@Override
	public Class<SourcePage> getTargetType() {
