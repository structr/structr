...
public class SourcePatternSUBPAGESourcePage extends OneToOne<SourcePattern, SourcePage> {
	...
	public static final View uiView = new View(SourcePatternSUBPAGESourcePage.class, "ui",
		sourceIdProperty, targetIdProperty
	);

	@Override
	public Class<SourcePattern> getSourceType() {
