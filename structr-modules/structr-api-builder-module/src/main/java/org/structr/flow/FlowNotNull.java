 ...
 *
 */
public class FlowNotNull extends FlowDataSource {

	public static final Property<List<FlowDataSource>> sources = new StartNodes<>("sources", FlowInput.class);

	public static final View defaultView = new View(FlowNotNull.class, PropertyView.Public, sources);
	public static final View uiView      = new View(FlowNotNull.class, PropertyView.Ui,     sources);
