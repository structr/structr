 ...
 *
 *
 * @source $URL: http://svn.osgeo.org/geotools/trunk/modules/library/render/src/main/java/org/geotools/renderer/label/LabelPainter.java $
 */
public class LabelPainter {
    ...
    public void paintStraightLabel(AffineTransform transform) throws Exception {
        ...
        try {
            ...
            if (graphic != null) {
                ...
                MetaDataShape tempShape = new MetaDataShape(gf.createPoint(new Coordinate(labelBounds
    ...
    private void drawGlyphVector(GlyphVector gv) {
        ...
        if(labelRenderingMode == LabelRenderingMode.STRING) {
            graphics.drawString(labelItem.getLabel(), 0, 0);
