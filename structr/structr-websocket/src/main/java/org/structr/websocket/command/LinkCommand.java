					...
					for (AbstractRelationship relIn : relsIn) {
						...
						if (relIn.getType().equals(RelType.CONTAINS.name())) {
							...
							for (String resourceIdFromRel : sourceRelationshipProperties.keySet()) {
								...
								RelationClass rel                      = new RelationClass(null, RelType.CONTAINS, Direction.OUTGOING, Cardinality.ManyToMany, null);
								...
								rel = new RelationClass(resourceNode.getType(), RelType.LINK, Direction.OUTGOING, Cardinality.ManyToMany, null);
