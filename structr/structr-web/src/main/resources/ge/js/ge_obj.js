function Node(g, id, size, pos) {
  ...
  this.zoomIn = function() {
    ...
    switch (self.size) {
      ...
      break;
          case "medium" : self.changeSize("medium", "large");
      break;
    }
  }
...
function Relationship(g, id, type, startNodeId, endNodeId) {
  ...
  this.redraw = function() {
      ...
      if (startNodeElement && startNodeElement.size() > 0 && endNodeElement && endNodeElement.size() > 0) {
        ...
        var ex = g.parent.offset().left;
        var ey = g.parent.offset().top;
        ...
        var fromX = startNodeElement.offset().left - ex + w1/2;
        var fromY = startNodeElement.offset().top - ey + h1/2;
        var toX = endNodeElement.offset().left - ex + w2/2;
        var toY = endNodeElement.offset().top - ey + h2/2;
