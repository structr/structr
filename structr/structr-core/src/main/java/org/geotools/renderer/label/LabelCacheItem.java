 ...
 *
 * @source $URL: http://svn.osgeo.org/geotools/trunk/modules/library/render/src/main/java/org/geotools/renderer/label/LabelCacheItem.java $
 */
public class LabelCacheItem implements Comparable<LabelCacheItem> {
     ...
     */
    public LabelCacheItem(String layerId, TextStyle2D textStyle, MetaDataShape shape, String label) {
