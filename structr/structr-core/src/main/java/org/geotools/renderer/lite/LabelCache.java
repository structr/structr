 ...
 * @author jeichar
 * @since 2.2
 * @source $URL: https://svn.osgeo.org/geotools/tags/2.7-M4/modules/library/render/src/main/java/org/geotools/renderer/lite/LabelCache.java $
 */
public interface LabelCache {
	 ...
	 */
	void put( String layerId, TextSymbolizer symbolizer, Feature feature, MetaDataShape shape, NumberRange<Double> scaleRange) ;
