    ...
    public Object execute(Object... parameters) {
        ...
        if (graphDb != null) {
            ...
            switch (parameters.length) {
                ...
                case 0:
                    // Return all groups
                    return (List<Group>) searchNode.execute(null, null, false, false, Search.andExactType(Group.class.getSimpleName()));
                ...
                case 1:
                    ...
                    if (parameters[0] instanceof String) {
                        ...
                        List<AbstractNode> groupsFound = (List<AbstractNode>) searchNode.execute(null, null, false, false, searchAttrs);
