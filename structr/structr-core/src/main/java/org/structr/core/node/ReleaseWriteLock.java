...
/**
 * Release write lock for the specified node
 *
 * @param node the node, a Long nodeId or a String nodeId
 *
 * @author amorgner
 */
public class ReleaseWriteLock extends NodeServiceCommand {

	private static final Logger logger = Logger.getLogger(ReleaseWriteLock.class.getName());
