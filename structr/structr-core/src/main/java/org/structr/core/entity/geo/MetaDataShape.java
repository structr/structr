 ...
 * </p>
 * @author Jesse Eichar
 * @source $URL: http://svn.osgeo.org/geotools/trunk/modules/library/main/src/main/java/org/geotools/geometry/jts/LiteShape2.java $
 * @version $Id: LiteShape2.java 36239 2010-10-02 14:29:29Z aaime $
 *
 * Added metadata
 *
 */
public final class MetaDataShape implements Shape, Cloneable {
	 ...
	 */
	public MetaDataShape(Geometry geom, MathTransform mathTransform,
	...
	public java.util.Map<String,Object> getCustomMetadata() {
		return customMetadata;
	}

        public void setCustomMetadata(final java.util.Map<String,Object> metadata) {
