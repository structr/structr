...
import org.structr.core.entity.web.NewsletterForm;
 ...
 */
public class NewsletterFormRenderer extends FormRenderer implements NodeRenderer<NewsletterForm>
{
	...
	@Override
	public void renderNode(StructrOutputStream out, NewsletterForm currentNode, AbstractNode startNode, String editUrl, Long editNodeId, RenderMode renderMode)
	{
...
//            String usernameFromSession = CurrentSession.getGlobalUsername();
	...
	@Override
	public String getContentType(NewsletterForm currentNode)
	{
		return ("text/html");
	}
}
