 ...
 * @author axel
 */
public class NewsletterForm extends WebNode {
    ...
    protected final static String defaultSubmitButtonName = "newsletterForm_submit";
    protected final static String defaultAntiRobotFieldName = "newsletterForm_antiRobot";
