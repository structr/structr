...
public class Ol extends HtmlElement {
	...
	static {
		...
		EntityContext.registerEntityRelation(Ol.class, Div.class,	RelType.CONTAINS, Direction.INCOMING, DirectedRelation.Cardinality.ManyToMany);
		EntityContext.registerEntityRelation(Ol.class, Li.class,	RelType.CONTAINS, Direction.OUTGOING, DirectedRelation.Cardinality.ManyToMany);
	}
}
