...
//	_Files.resize();
	...
	$('.delete_icon', file).replaceWith('<img title="Delete file ' + fileId + '" '
	...
	_Entities.resetMouseOverState(image);
	images.append(image);//.animate();
	$('.delete_icon', image).replaceWith('<img title="Delete image ' + imageId + '" '
