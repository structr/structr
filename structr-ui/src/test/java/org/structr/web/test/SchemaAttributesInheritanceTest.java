		...
		try (final Tx tx = app.tx()) {
			...
			RestAssured
				...
				.expect()
					...
					.body("result[31].jsonName",       equalTo("testSubFile"))
					.body("result[31].declaringClass", equalTo("SubFile"))
		...
		try (final Tx tx = app.tx()) {
			...
			RestAssured
				...
				.expect()
					...
					.body("result[37].jsonName",       equalTo("testSubFile"))
					.body("result[37].declaringClass", equalTo("SubFile"))
