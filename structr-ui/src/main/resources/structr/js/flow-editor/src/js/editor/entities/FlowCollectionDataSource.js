...
export class FlowCollectionDataSource extends FlowNode {
    ...
    getComponent() {
        ...
        return new D3NE.Component('FlowCollectionDataSource', {
            template: FlowCollectionDataSource._nodeTemplate(),
            builder(node) {
