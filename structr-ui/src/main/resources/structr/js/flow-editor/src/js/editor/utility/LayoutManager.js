...
export class LayoutManager {
    ...
    async getSavedLayouts(raw) {
        ...
        let r = await this._rest.get('/structr/rest/FlowContainerConfiguration?&flow=' + this._flowEditor._flowContainer.id + '&validForEditor=' + this._flowEditor._editorId + '&sort=lastModifiedDate&order=desc');
