...
var _Icons = {
	...
	svg: {
		trashcan:       (height = 16, width = 16) => { return `<svg viewBox="0 0 24 24" height="${height}" width="${width}" xmlns="http://www.w3.org/2000/svg"><g><path d="M1.5 4.5L22.5 4.5" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"></path><path d="M14.25,1.5H9.75A1.5,1.5,0,0,0,8.25,3V4.5h7.5V3A1.5,1.5,0,0,0,14.25,1.5Z" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"></path><path d="M9.75 17.25L9.75 9.75" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"></path><path d="M14.25 17.25L14.25 9.75" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"></path><path d="M18.865,21.124A1.5,1.5,0,0,1,17.37,22.5H6.631a1.5,1.5,0,0,1-1.495-1.376L3.75,4.5h16.5Z" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"></path></g></svg>`; },
		security:       (height = 16, width = 16) => { return `<svg viewBox="0 0 24 24" height="${height}" width="${width}" xmlns="http://www.w3.org/2000/svg"><g><path d="M3.750 9.750 L20.250 9.750 L20.250 23.250 L3.750 23.250 Z" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"></path><path d="M6.75,9.75V6a5.25,5.25,0,0,1,10.5,0V9.75" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"></path><path d="M12,15.75a.375.375,0,1,0,.375.375A.374.374,0,0,0,12,15.75h0" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"></path></g></svg>`; },
		page_settings:  (height = 16, width = 16) => { return `<svg viewBox="0 0 24 24" height="${height}" width="${width}" xmlns="http://www.w3.org/2000/svg"><g><path d="M21.76,8.253v-6a1.5,1.5,0,0,0-1.5-1.5h-18a1.5,1.5,0,0,0-1.5,1.5v16.5a1.5,1.5,0,0,0,1.5,1.5h6" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"></path><path d="M0.76 5.253L21.76 5.253" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"></path><path d="M15.760 16.503 A1.500 1.500 0 1 0 18.760 16.503 A1.500 1.500 0 1 0 15.760 16.503 Z" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"></path><path d="M18.534,10.7l.443,1.452a.992.992,0,0,0,1.173.681l1.472-.341A1.339,1.339,0,0,1,22.9,14.711l-1.031,1.111a1,1,0,0,0,0,1.362L22.9,18.3a1.339,1.339,0,0,1-1.275,2.218l-1.472-.341a.992.992,0,0,0-1.173.681l-.443,1.452a1.33,1.33,0,0,1-2.548,0l-.442-1.452a.993.993,0,0,0-1.174-.681l-1.472.341A1.338,1.338,0,0,1,11.624,18.3l1.03-1.112a1,1,0,0,0,0-1.362l-1.03-1.111A1.338,1.338,0,0,1,12.9,12.493l1.472.341a.993.993,0,0,0,1.174-.681l.442-1.452A1.33,1.33,0,0,1,18.534,10.7Z" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"></path></g></svg>`; },
		page_open:      (height = 16, width = 16) => { return `<svg viewBox="0 0 24 24" height="${height}" width="${width}" xmlns="http://www.w3.org/2000/svg"><g><path d="M1.510 2.253 L22.510 2.253 L22.510 21.753 L1.510 21.753 Z" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"></path><path d="M1.51 6.753L22.51 6.753" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"></path><path d="M17.858,13.807a.732.732,0,0,1,0,.894C17.1,15.7,15.015,18,12.01,18S6.92,15.7,6.162,14.7a.734.734,0,0,1,0-.894c.759-.994,2.843-3.3,5.848-3.3S17.1,12.812,17.858,13.807Z" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"></path><path d="M12.01,13.878a.375.375,0,1,1-.375.375.375.375,0,0,1,.375-.375" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"></path></g></svg>`; },
		pencil_edit:    (height = 16, width = 16) => { return `<svg viewBox="0 0 24 24" height="${height}" width="${width}" xmlns="http://www.w3.org/2000/svg"><g><path d="M22.19,1.81a3.638,3.638,0,0,0-5.169.035l-14.5,14.5L.75,23.25l6.905-1.771,14.5-14.5A3.638,3.638,0,0,0,22.19,1.81Z" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"></path><path d="M16.606 2.26L21.74 7.394" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"></path><path d="M14.512 4.354L19.646 9.488" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"></path><path d="M2.521 16.345L7.66 21.474" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"></path></g></svg>`; },
		import_page:    (height = 16, width = 16) => { return `<svg viewBox="0 0 24 24" height="${height}" width="${width}" xmlns="http://www.w3.org/2000/svg"><g><path d="M11.250 17.250 A6.000 6.000 0 1 0 23.250 17.250 A6.000 6.000 0 1 0 11.250 17.250 Z" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"></path><path d="M17.25 14.25L17.25 20.25" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"></path><path d="M14.25 17.25L20.25 17.25" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"></path><path d="M8.25,20.25h-6a1.5,1.5,0,0,1-1.5-1.5V2.25A1.5,1.5,0,0,1,2.25.75H12.879a1.5,1.5,0,0,1,1.06.439l2.872,2.872a1.5,1.5,0,0,1,.439,1.06V8.25" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"></path></g></svg>`; },
		circle_plus:    (height = 16, width = 16) => { return `<svg viewBox="0 0 24 24" height="${height}" width="${width}" xmlns="http://www.w3.org/2000/svg"><g><path d="M12 7.5L12 16.5" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"></path><path d="M7.5 12L16.5 12" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"></path><path d="M0.750 12.000 A11.250 11.250 0 1 0 23.250 12.000 A11.250 11.250 0 1 0 0.750 12.000 Z" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"></path></g></svg>`; },
		add_template:   (height = 16, width = 16) => { return `<svg viewBox="0 0 24 24" height="${height}" width="${width}" xmlns="http://www.w3.org/2000/svg"><g><path d="M22.151,2.85,20.892,6.289l2.121,2.122a.735.735,0,0,1-.541,1.273l-3.653-.029L17.5,13.018a.785.785,0,0,1-1.485-.1L14.932,9.07,11.08,7.991a.786.786,0,0,1-.1-1.486l3.363-1.323-.029-3.653A.734.734,0,0,1,15.588.986L17.71,3.107,21.151,1.85A.8.8,0,0,1,22.151,2.85Z" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"></path><path d="M14.932 9.07L0.75 23.25" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"></path></g></svg>`; },
		kebab_icon:     (height = 16, width = 16) => { return `<svg viewBox="0 0 24 24" height="${height}" width="${width}" xmlns="http://www.w3.org/2000/svg"><g><path d="M8.750 3.250 A3.250 3.250 0 1 0 15.250 3.250 A3.250 3.250 0 1 0 8.750 3.250 Z" fill="currentColor" stroke="none" stroke-linecap="round" stroke-linejoin="round"></path><path d="M8.750 12.000 A3.250 3.250 0 1 0 15.250 12.000 A3.250 3.250 0 1 0 8.750 12.000 Z" fill="currentColor" stroke="none" stroke-linecap="round" stroke-linejoin="round"></path><path d="M8.750 20.750 A3.250 3.250 0 1 0 15.250 20.750 A3.250 3.250 0 1 0 8.750 20.750 Z" fill="currentColor" stroke="none" stroke-linecap="round" stroke-linejoin="round"></path></g></svg>`; },
		duplicate:      (height = 16, width = 16) => { return `<svg viewBox="0 0 24 24" height="${height}" width="${width}" xmlns="http://www.w3.org/2000/svg"><g><path d="M16.5,21.75a1.5,1.5,0,0,1-1.5,1.5H4.5A1.5,1.5,0,0,1,3,21.75V8.25a1.5,1.5,0,0,1,1.5-1.5h7.629a1.5,1.5,0,0,1,1.06.439l2.872,2.872a1.5,1.5,0,0,1,.439,1.06Z" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"></path><path d="M7.5,6.75V2.25A1.5,1.5,0,0,1,9,.75h7.629a1.5,1.5,0,0,1,1.06.439l2.872,2.872A1.5,1.5,0,0,1,21,5.121V15.75a1.5,1.5,0,0,1-1.5,1.5h-3" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"></path></g></svg>`; },

		checkmark_bold: (height = 12, width = 12) => { return `<svg viewBox="0 0 10 10" height="${height}" width="${width}" xmlns="http://www.w3.org/2000/svg"><g><path d="M2.99,9.375a1.713,1.713,0,0,1-1.321-.619L.161,6.839a.75.75,0,1,1,1.178-.928l1.5,1.9a.16.16,0,0,0,.158.063.217.217,0,0,0,.17-.082L8.664.907a.75.75,0,1,1,1.172.936L4.329,8.735A1.717,1.717,0,0,1,3,9.375Z" fill="currentColor" stroke="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="0"></path></g></svg>`; },
	},
