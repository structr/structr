	...
	public static StructrOAuthClient getServer(final String name) {
		...
		for (String authServer : authServers) {
			...
			if (authServer.equals(name)) {
				...
				String authLocation  = Settings.getStringSetting("oauth", authServer, "authorization_location").getValue();
				String tokenLocation = Settings.getStringSetting("oauth", authServer, "token_location").getValue();
				String clientId      = Settings.getStringSetting("oauth", authServer, "client_id").getValue();
				String clientSecret  = Settings.getStringSetting("oauth", authServer, "client_secret").getValue();
				String redirectUri   = Settings.getStringSetting("oauth", authServer, "redirect_uri").getValue();
