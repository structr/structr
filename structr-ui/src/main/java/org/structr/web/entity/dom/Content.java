...
public class Content extends DOMNode implements Text {
	...
	public static final org.structr.common.View uiView                                   = new org.structr.common.View(Content.class, PropertyView.Ui, content, contentType, size, parent, ownerDocument);
