...
public class NewsTickerItem extends AbstractNode {
	...
	public static final End<Content>	text		= new End("text", Content.class, RelType.CONTAINS, Direction.OUTGOING, new PropertySetNotion(true, uuid, Content.content), false);
	public static final Property<Date>		publishDate	= new ISO8601DateProperty("publishDate").indexed();
	public static final End<Principal>   author		= new End("author", Principal.class, org.structr.web.common.RelType.AUTHOR, Direction.INCOMING, true);
