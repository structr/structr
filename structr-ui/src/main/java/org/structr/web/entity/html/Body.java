...
//	public static final EndNodes<Article>    articles    = new EndNodes<Article>("articles", Article.class, RelType.CONTAINS, Direction.OUTGOING, false);
//	public static final EndNodes<Blockquote> blockquotes = new EndNodes<Blockquote>("blockquotes", Blockquote.class, RelType.CONTAINS, Direction.OUTGOING, false);
