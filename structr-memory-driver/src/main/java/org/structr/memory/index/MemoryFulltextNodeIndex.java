...
/**
 * Note: This is a copy of the MemoryNodeIndex
 */
public class MemoryFulltextNodeIndex extends AbstractMemoryIndex<Node> {

	public MemoryFulltextNodeIndex(final MemoryDatabaseService db) {
