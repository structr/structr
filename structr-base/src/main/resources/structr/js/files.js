...
let _Files = {
	...
	onload: () => {
		...
		let initFunctionBar = async () => {
			...
			let fileTypes   = await _Schema.getDerivedTypes('org.structr.web.entity.File', ['CsvFile']);
			let folderTypes = await _Schema.getDerivedTypes('org.structr.web.entity.Folder', ['Trash']);
