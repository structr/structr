 ...
 *
 */
public class PythonHintProvider extends AbstractHintProvider {

	protected static final Logger logger = LoggerFactory.getLogger(PythonHintProvider.class);
