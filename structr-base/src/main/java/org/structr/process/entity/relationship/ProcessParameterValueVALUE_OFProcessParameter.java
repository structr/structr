...
public class ProcessParameterValueVALUE_OFProcessParameter extends ManyToOne<ProcessParameterValue, ProcessParameter> {
    ...
    @Override
    public Class<ProcessParameterValue> getSourceType() {
