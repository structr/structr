...
public class StructrTraits {
	...
	public static final String PROCESS_DECISION                    = "ProcessDecision";
	...
	public static final String TEMPLATEELEMENT =  "TemplateElement";
	...
	public static final String DOM_NODE_PROCESS_SHOW_ELEMENT_ON_SUCCESS_ACTION_MAPPING        = "DOMNodePROCESS_SHOW_ELEMENT_ON_SUCCESSActionMapping";
	public static final String DOM_NODE_PROCESS_HIDE_ELEMENT_ON_SUCCESS_ACTION_MAPPING        = "DOMNodePROCESS_HIDE_ELEMENT_ON_SUCCESSActionMapping";
	public static final String DOM_NODE_PROCESS_SHOW_ELEMENT_ON_FAILURE_ACTION_MAPPING        = "DOMNodePROCESS_SHOW_ELEMENT_ON_FAILUREActionMapping";
	public static final String DOM_NODE_PROCESS_HIDE_ELEMENT_ON_FAILURE_ACTION_MAPPING        = "DOMNodePROCESS_HIDE_ELEMENT_ON_FAILUREActionMapping";

	public static final String PROCESS_DECISION_POSSIBLE_STATE_PROCESS_STATE                  = "ProcessDecisionPOSSIBLE_STATEProcessState";
	public static final String PROCESS_HAS_STEP_PROCESS_STEP                                  = "ProcessHAS_STEPProcessStep";
	public static final String PROCESS_INITIAL_STATE_PROCESS_STATE                            = "ProcessINITIAL_STATEProcessState";
	public static final String PROCESS_INSTANCE_CURRENT_STATE_PROCESS_STATE                   = "ProcessInstanceCURRENT_STATEProcessState";
	public static final String PROCESS_INSTANCE_HAS_PARAMETER_PROCESS_PARAMETER_VALUE         = "ProcessInstanceHAS_PARAMETERProcessParameterValue";
	public static final String PROCESS_INSTANCE_INSTANCE_OF_PROCESS                           = "ProcessInstanceINSTANCE_OFProcess";
	public static final String PROCESS_PARAMETER_VALUE_VALUE_OF_PROCESS_PARAMETER             = "ProcessParameterValueVALUE_OFProcessParameter";
	public static final String PROCESS_STATE_NEXT_STEP_PROCESS_STEP                           = "ProcessStateNEXT_STEPProcessStep";
	public static final String PROCESS_STATE_STATE_PARAMETER_PROCESS_PARAMETER                = "ProcessStateSTATE_PARAMETERProcessParameter";
	public static final String PROCESS_STEP_LEADS_TO_PROCESS_DECISION                         = "ProcessStepLEADS_TOProcessDecision";
	public static final String PROCESS_STEP_STEP_PARAMETER_PROCESS_PARAMETER                  = "ProcessStepSTEP_PARAMETERProcessParameter";
