...
public class SchemaNodeMethodDefinition extends AbstractRelationshipTraitDefinition implements RelationshipBaseTraitDefinition {

	public SchemaNodeMethodDefinition() {
		super(StructrTraits.SCHEMA_NODE_METHOD);
	}
