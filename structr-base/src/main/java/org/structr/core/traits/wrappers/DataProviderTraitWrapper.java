...
public class DataProviderTraitWrapper extends AbstractNodeTraitWrapper implements DataProvider {

	public DataProviderTraitWrapper(final Traits traits, final NodeInterface wrappedObject) {
		super(traits, wrappedObject);
	}

	@Override
	public final Iterable<GraphObject> getValues(SecurityContext securityContext) throws FrameworkException {
		return traits.getMethod(DataProviderOperations.class).getValues(securityContext, this);
	}
