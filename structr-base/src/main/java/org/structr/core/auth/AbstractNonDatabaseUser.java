...
public abstract class AbstractNonDatabaseUser implements Principal, AccessControllable, NonIndexed {
	...
	public AbstractNonDatabaseUser(final String id, final String name, final String appId) {
	...
	public int compareTo(final Object other) {
		...
		final AbstractNonDatabaseUser u = (AbstractNonDatabaseUser)other;
	...
	public Iterable<Principal> getParentsPrivileged() {
		...
		if (group == null) {
			...
			try {
				...
				group = StructrApp.getInstance().nodeQuery(Group.class).and(StructrApp.key(Group.class, "appId"), appId).getFirst();
