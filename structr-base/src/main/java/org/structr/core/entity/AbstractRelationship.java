...
public final class AbstractRelationship<IDType> extends AbstractGraphObject<Relationship<IDType>> implements Comparable<AbstractRelationship<IDType>>, RelationshipInterface {
	...
	@Override
	public Object evaluate(final ActionContext actionContext, final String key, final String defaultValue, GraphObject contextObject, final int row, final int column) throws FrameworkException {
