...
public interface SchemaRelationshipNode extends AbstractSchemaNode {
	...
	String getClassName();
	String getMultiplicity(final Map<String, NodeInterface> schemaNodes, final String propertyNameToCheck);
	String getRelatedType(final Map<String, NodeInterface> schemaNodes, final String propertyNameToCheck);
