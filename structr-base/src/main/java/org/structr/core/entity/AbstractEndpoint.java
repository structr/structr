...
public abstract class AbstractEndpoint {
	...
	public Iterable<Relationship> getMultiple(final SecurityContext securityContext, final Node dbNode, final RelationshipType relationshipType, final Direction direction, final Class otherNodeType, final Predicate<NodeInterface> predicate) {
