...
public class IdentifierWithPlus extends Tokenizer {
	...
	public boolean accept(final char character) {
		...
		return Character.isAlphabetic(character) || Character.isDigit(character) || character == '_' || character == '.' || character == '!' || character == '-' || character == '+';
	}
