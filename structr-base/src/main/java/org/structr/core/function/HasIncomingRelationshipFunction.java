...
public class HasIncomingRelationshipFunction extends CoreFunction {
	...
	public List<Usage> getUsages() {
		...
		return List.of(Usage.structrScript("Usage: ${hasIncomingRelationship(from, to [, relType])}."), Usage.javaScript("Usage: ${{$.hasIncomingRelationship(from, to [, relType])}}."));
	}
	...
	public List<Example> getExamples() {
		...
		return List.of(Example.structrScript("${hasIncomingRelationship(me, page, 'OWNS')}"), Example.javaScript("${{ $.hasIncomingRelationship($.me, $.page, 'OWNS') }}"));
	}
