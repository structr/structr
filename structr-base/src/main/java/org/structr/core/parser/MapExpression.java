...
public class MapExpression extends Expression {
	...
	public List<Example> getExamples() {
		...
		return List.of(Example.structrScript("${map(find('User'), data.name)}", "Return only the names of all users"));
	}
	...
	public List<Signature> getSignatures() {
		...
		return List.of(Signature.structrScript("list, transformationExpression"));
	}
	...
	public List<Usage> getUsages() {
		...
		return List.of(Usage.structrScript("Usage: ${map(list, transformationExpression)}. Example: ${map(user.groups, data.name)}"));
	}
