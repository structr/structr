 ...
 *
 */
public class IntegerArrayPropertyParser extends NumericalArrayPropertyGenerator<Integer> {
	...
	public List<IsValid> getValidators(final PropertyKey<Integer[]> key) throws FrameworkException {
		...
		if (!error) {
			...
			validators.add((obj, errorBuffer) -> ValidationHelper.isValidIntegerArrayInRange(obj, key, source.getFormat(), errorBuffer));
		}
