 ...
 *
 */
public class LongPropertyParser extends NumericalPropertyParser<Long> {
	...
	protected Property<Long> newInstance() throws FrameworkException {
		return new LongProperty(source.getPropertyName(), source.getDbName());
	}
	...
	public List<IsValid> getValidators(final PropertyKey<Long> key) throws FrameworkException {
		...
		if (!error) {
			...
			validators.add((obj, errorBuffer) -> ValidationHelper.isValidLongInRange(obj, key, source.getFormat(), errorBuffer));
		}
