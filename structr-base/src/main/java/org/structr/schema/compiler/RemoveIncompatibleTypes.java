...
public class RemoveIncompatibleTypes  implements MigrationHandler {

	private static final Pattern PATTERN = Pattern.compile("incompatible types: unexpected return value.*", Pattern.DOTALL);
	private static final Logger logger   = LoggerFactory.getLogger(RemoveIncompatibleTypes.class);
