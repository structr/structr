 ...
 *
 */
public class LogObjectTraitDefinition extends AbstractTraitDefinition {

	public static final Property<Iterable<NodeInterface>> logEvents = new StartNodes("logEvents", "ObjectEventRelationship");
