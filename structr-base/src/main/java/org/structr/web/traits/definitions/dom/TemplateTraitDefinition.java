...
@Documentation(name="Template", type=ConceptType.SystemType, shortDescription="Templates are special elements that may be inserted into a page's DOM tree at any position.", synonyms={"Template element", "Main Page Template"})
