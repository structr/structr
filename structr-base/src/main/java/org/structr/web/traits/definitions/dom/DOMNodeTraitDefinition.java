...
public class DOMNodeTraitDefinition extends AbstractTraitDefinition {
	...
	*/
	...
	public Set<PropertyKey> getPropertyKeys() {
		...
		final Property<NodeInterface> parentProperty                               = new StartNode("parent", "DOMNodeCONTAINSDOMNode").category(DOMNode.PAGE_CATEGORY).partOfBuiltInSchema();
		final Property<Iterable<NodeInterface>> childrenProperty                   = new EndNodes("children", "DOMNodeCONTAINSDOMNode").category(DOMNode.PAGE_CATEGORY).partOfBuiltInSchema();
		final Property<NodeInterface> previousSiblingProperty                      = new StartNode("previousSibling", "DOMNodeCONTAINS_NEXT_SIBLINGDOMNode").category(DOMNode.PAGE_CATEGORY).partOfBuiltInSchema();
		final Property<NodeInterface> nextSiblingProperty                          = new EndNode("nextSibling", "DOMNodeCONTAINS_NEXT_SIBLINGDOMNode").category(DOMNode.PAGE_CATEGORY).partOfBuiltInSchema();
		final Property<NodeInterface> sharedComponentProperty                      = new StartNode("sharedComponent", "DOMNodeSYNCDOMNode").category(DOMNode.PAGE_CATEGORY).partOfBuiltInSchema();
		final Property<Iterable<NodeInterface>> syncedNodesProperty                = new EndNodes("syncedNodes", "DOMNodeSYNCDOMNode").category(DOMNode.PAGE_CATEGORY).partOfBuiltInSchema();
		final Property<NodeInterface> ownerDocumentProperty                        = new EndNode("ownerDocument", "DOMNodePAGEPage").category(DOMNode.PAGE_CATEGORY).partOfBuiltInSchema();
		final Property<Iterable<NodeInterface>> reloadingActionsProperty           = new EndNodes("reloadingActions", "DOMNodeSUCCESS_TARGETActionMapping").partOfBuiltInSchema();
		final Property<Iterable<NodeInterface>> failureActionsProperty             = new EndNodes("failureActions", "DOMNodeFAILURE_TARGETActionMapping").partOfBuiltInSchema();
		final Property<Iterable<NodeInterface>> successNotificationActionsProperty = new EndNodes("successNotificationActions", "DOMNodeSUCCESS_NOTIFICATION_ELEMENTActionMapping").partOfBuiltInSchema();
		final Property<Iterable<NodeInterface>> failureNotificationActionsProperty = new EndNodes("failureNotificationActions", "DOMNodeFAILURE_NOTIFICATION_ELEMENTActionMapping").partOfBuiltInSchema();
		final Property<Object> sortedChildrenProperty                              = new MethodProperty("sortedChildren").format("org.structr.web.entity.dom.DOMNode, getChildNodes").typeHint("DOMNode[]").partOfBuiltInSchema();
		final Property<String> childrenIdsProperty                                 = new CollectionIdProperty("childrenIds", childrenProperty).format("children, {},").partOfBuiltInSchema().category("Page Structure").partOfBuiltInSchema();
		final Property<String> nextSiblingIdProperty                               = new EntityIdProperty("nextSiblingId", nextSiblingProperty).format("nextSibling, {},").partOfBuiltInSchema().category("Page Structure").partOfBuiltInSchema();
		final Property<String> pageIdProperty                                      = new EntityIdProperty("pageId", ownerDocumentProperty).format("ownerDocument, {},").partOfBuiltInSchema().category("Page Structure").partOfBuiltInSchema();
		final Property<String> parentIdProperty                                    = new EntityIdProperty("parentId", parentProperty).format("parent, {},").partOfBuiltInSchema().category("Page Structure").partOfBuiltInSchema();
		final Property<String> sharedComponentIdProperty                           = new EntityIdProperty("sharedComponentId", sharedComponentProperty).format("sharedComponent, {},").partOfBuiltInSchema();
		final Property<String> syncedNodesIdsProperty                              = new CollectionIdProperty("syncedNodesIds", syncedNodesProperty).format("syncedNodes, {},").partOfBuiltInSchema();
		final Property<String> dataKeyProperty                                     = new StringProperty("dataKey").indexed().category(DOMNode.QUERY_CATEGORY).partOfBuiltInSchema();
		final Property<String> cypherQueryProperty                                 = new StringProperty("cypherQuery").category(DOMNode.QUERY_CATEGORY).partOfBuiltInSchema();
		final Property<String> restQueryProperty                                   = new StringProperty("restQuery").category(DOMNode.QUERY_CATEGORY).partOfBuiltInSchema();
		final Property<String> functionQueryProperty                               = new StringProperty("functionQuery").category(DOMNode.QUERY_CATEGORY).partOfBuiltInSchema();
		final Property<String> showForLocalesProperty                              = new StringProperty("showForLocales").indexed().category(GraphObject.VISIBILITY_CATEGORY).partOfBuiltInSchema();
		final Property<String> hideForLocalesProperty                              = new StringProperty("hideForLocales").indexed().category(GraphObject.VISIBILITY_CATEGORY).partOfBuiltInSchema();
		final Property<String> showConditionsProperty                              = new StringProperty("showConditions").indexed().category(GraphObject.VISIBILITY_CATEGORY).hint("Conditions which have to be met in order for the element to be shown.<br><br>This is an 'auto-script' environment, meaning that the text is automatically surrounded with ${}").partOfBuiltInSchema();
		...
		final Property<String> dataStructrIdProperty                               = new StringProperty("data-structr-id").hint("Set to ${current.id} most of the time").category(DOMNode.PAGE_CATEGORY).partOfBuiltInSchema();
		final Property<String> dataStructrHashProperty                             = new StringProperty("data-structr-hash").category(DOMNode.PAGE_CATEGORY).partOfBuiltInSchema();
		final Property<Boolean> dontCacheProperty                                  = new BooleanProperty("dontCache").defaultValue(false).partOfBuiltInSchema();
		final Property<Boolean> isDOMNodeProperty                                  = new ConstantBooleanProperty("isDOMNode", true).category(DOMNode.PAGE_CATEGORY).partOfBuiltInSchema();
		final Property<Boolean> hasSharedComponent                                 = new BooleanProperty("hasSharedComponent").indexed().partOfBuiltInSchema();
		final Property<Integer> domSortPositionProperty                            = new IntProperty("domSortPosition").category(DOMNode.PAGE_CATEGORY).partOfBuiltInSchema();
