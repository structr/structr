...
public class DOMNodeTraitDefinition extends AbstractNodeTraitDefinition {
	...
	*/
	...
	public Set<PropertyKey> getPropertyKeys() {
		...
		final Property<String> childrenIdsProperty                                 = new CollectionIdProperty("childrenIds", childrenProperty).format("children, {},").category("Page Structure");
		final Property<String> nextSiblingIdProperty                               = new EntityIdProperty("nextSiblingId", nextSiblingProperty).format("nextSibling, {},").category("Page Structure");
		final Property<String> pageIdProperty                                      = new EntityIdProperty("pageId", ownerDocumentProperty).format("ownerDocument, {},").category("Page Structure");
		final Property<String> parentIdProperty                                    = new EntityIdProperty("parentId", parentProperty).format("parent, {},").category("Page Structure");
		final Property<String> sharedComponentIdProperty                           = new EntityIdProperty("sharedComponentId", sharedComponentProperty).format("sharedComponent, {},");
		final Property<String> syncedNodesIdsProperty                              = new CollectionIdProperty("syncedNodesIds", syncedNodesProperty).format("syncedNodes, {},");
