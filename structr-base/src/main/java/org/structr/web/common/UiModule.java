...
public class UiModule implements StructrModule {
	...
	public void onLoad(final LicenseManager licenseManager) {
		...
		StructrTraits.registerRelationshipType(StructrTraits.ACTION_MAPPING_CONTROLS_PROCESS,                                new ActionMappingCONTROLSProcess());
		StructrTraits.registerRelationshipType(StructrTraits.ACTION_MAPPING_TRIGGERS_PROCESS_STEP,                            new ActionMappingTRIGGERSProcessStep());
		StructrTraits.registerRelationshipType(StructrTraits.DOM_NODE_PROCESS_SHOW_ELEMENT_ON_SUCCESS_ACTION_MAPPING,        new DOMNodePROCESS_SHOW_ELEMENT_ON_SUCCESSActionMapping());
		StructrTraits.registerRelationshipType(StructrTraits.DOM_NODE_PROCESS_HIDE_ELEMENT_ON_SUCCESS_ACTION_MAPPING,        new DOMNodePROCESS_HIDE_ELEMENT_ON_SUCCESSActionMapping());
		StructrTraits.registerRelationshipType(StructrTraits.DOM_NODE_PROCESS_SHOW_ELEMENT_ON_FAILURE_ACTION_MAPPING,        new DOMNodePROCESS_SHOW_ELEMENT_ON_FAILUREActionMapping());
		StructrTraits.registerRelationshipType(StructrTraits.DOM_NODE_PROCESS_HIDE_ELEMENT_ON_FAILURE_ACTION_MAPPING,        new DOMNodePROCESS_HIDE_ELEMENT_ON_FAILUREActionMapping());
		StructrTraits.registerRelationshipType(StructrTraits.PROCESS_DECISION_POSSIBLE_STATE_PROCESS_STATE,                  new ProcessDecisionPOSSIBLE_STATEProcessState());
		StructrTraits.registerRelationshipType(StructrTraits.PROCESS_HAS_STEP_PROCESS_STEP,                                  new ProcessHAS_STEPProcessStep());
		StructrTraits.registerRelationshipType(StructrTraits.PROCESS_INITIAL_STATE_PROCESS_STATE,                            new ProcessINITIAL_STATEProcessState());
		StructrTraits.registerRelationshipType(StructrTraits.PROCESS_INSTANCE_CURRENT_STATE_PROCESS_STATE,                   new ProcessInstanceCURRENT_STATEProcessState());
		StructrTraits.registerRelationshipType(StructrTraits.PROCESS_INSTANCE_HAS_PARAMETER_PROCESS_PARAMETER_VALUE,         new ProcessInstanceHAS_PARAMETERProcessParameterValue());
		StructrTraits.registerRelationshipType(StructrTraits.PROCESS_INSTANCE_INSTANCE_OF_PROCESS,                           new ProcessInstanceINSTANCE_OFProcess());
		StructrTraits.registerRelationshipType(StructrTraits.PROCESS_PARAMETER_VALUE_VALUE_OF_PROCESS_PARAMETER,             new ProcessParameterValueVALUE_OFProcessParameter());
		StructrTraits.registerRelationshipType(StructrTraits.PROCESS_STATE_NEXT_STEP_PROCESS_STEP,                           new ProcessStateNEXT_STEPProcessStep());
		StructrTraits.registerRelationshipType(StructrTraits.PROCESS_STATE_STATE_PARAMETER_PROCESS_PARAMETER,                new ProcessStateSTATE_PARAMETERProcessParameter());
		StructrTraits.registerRelationshipType(StructrTraits.PROCESS_STEP_LEADS_TO_PROCESS_DECISION,                         new ProcessStepLEADS_TOProcessDecision());
		StructrTraits.registerRelationshipType(StructrTraits.PROCESS_STEP_STEP_PARAMETER_PROCESS_PARAMETER,                  new ProcessStepSTEP_PARAMETERProcessParameter());


		StructrTraits.registerRelationshipType(StructrTraits.PROCESS_INITIAL_STATE_PROCESS_STATE,        new DOMNodePROCESS_SHOW_ELEMENT_ON_SUCCESSActionMapping());
		...
		StructrTraits.registerNodeType(StructrTraits.PROCESS,                             new ProcessTraitDefinition());
		StructrTraits.registerNodeType(StructrTraits.PROCESS_DECISION,                    new ProcessDecisionTraitDefinition());
		StructrTraits.registerNodeType(StructrTraits.PROCESS_INSTANCE,                    new ProcessInstanceTraitDefinition());
		StructrTraits.registerNodeType(StructrTraits.PROCESS_PARAMETER,                   new ProcessParameterTraitDefinition());
		StructrTraits.registerNodeType(StructrTraits.PROCESS_PARAMETER_VALUE,             new ProcessParameterValueTraitDefinition());
		StructrTraits.registerNodeType(StructrTraits.PROCESS_STATE,                       new ProcessStateTraitDefinition());
		StructrTraits.registerNodeType(StructrTraits.PROCESS_STEP,                        new ProcessStepTraitDefinition());
