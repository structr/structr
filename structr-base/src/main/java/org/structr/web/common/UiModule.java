...
public class UiModule implements StructrModule {
	...
	public void onLoad() {
        ...
        StructrTraits.registerNodeType(StructrTraits.PROCESS,                             StructrTraits.PROCESS);
        StructrTraits.registerNodeType(StructrTraits.PROCESS_DECISION,                    StructrTraits.PROCESS_DECISION);
        ...
        StructrTraits.registerNodeType(StructrTraits.PROCESS_STATE,                       StructrTraits.PROCESS_STATE);
        StructrTraits.registerNodeType(StructrTraits.PROCESS_STEP,                        StructrTraits.PROCESS_STEP);
