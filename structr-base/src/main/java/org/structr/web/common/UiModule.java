...
public class UiModule implements StructrModule {
	...
	public void registerModuleFunctions(final LicenseManager licenseManager) {
		...
		Functions.put(licenseManager, new GetThemeFunction());
		...
		Functions.put(licenseManager, new GetComponentFunction());
		...
		Functions.put(licenseManager, new HttpFetchFunction());
		...
		Functions.put(licenseManager, new GetRequestHeaderNamesFunction());
