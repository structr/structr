...
public class CssRuleHAS_DECLARATIONCssDeclaration extends OneToMany<CssRule, CssDeclaration> {
	
	@Override
	public Class<CssRule> getSourceType() {
		return CssRule.class;
	}

	@Override
	public Class<CssDeclaration> getTargetType() {
