 ...
 */
public class AzureOAuthClient extends AbstractOAuth2Client {

	private static final String AUTH_SERVER = "azure";

	public AzureOAuthClient(final HttpServletRequest request, OAuth2ProviderRegistry.ProviderConfig providerConfig) {
