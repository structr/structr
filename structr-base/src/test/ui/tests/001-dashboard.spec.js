...
test('dashboard', async ({ page }) => {
  ...
  await page.screenshot({ path: 'login.png', caret: 'initial' });
  ...
  await page.waitForTimeout(1000);
  await page.screenshot({ path: 'dashboard_about-me.png' });
