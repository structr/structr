...
class CypherRelationshipIndex extends AbstractCypherIndex<Relationship<String>> {
	...
	@Override
	public Map<Relationship<String>, Double> fulltextQuery(final String indexName, final String searchString) {
		...
		final Map<Relationship<String>, Double> nodes = new LinkedHashMap<>();
