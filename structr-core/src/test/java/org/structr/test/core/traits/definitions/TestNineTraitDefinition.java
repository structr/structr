...
public class TestNineTraitDefinition extends AbstractTraitDefinition {
		...
		return Map.of(
			...
			new IsValid() {
				...
				public Boolean isValid(final GraphObject obj, final ErrorBuffer errorBuffer) {
					...
					final PropertyKey<NodeInterface> key = obj.getTraits().key("oneToManyTestSixConstraint");

					return obj.getProperty(key) != null;
				}
			}
		);
	}
