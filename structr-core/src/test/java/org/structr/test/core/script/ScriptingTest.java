...
//			assertEquals("Invalid if(eq()) result with null value", "false",  Scripting.replaceVariables(ctx, testOne, "${eq(this.alwaysNull, 2.34462e-3)}"));
	...
	public void testNewFindSyntaxInJavaScript() {
		...
		try (final Tx tx = app.tx()) {
			...
			assertEquals("Advanced search() returns wrong result", 1, ((List)Scripting.evaluate(ctx, null, "${{ return $.search('Project', $.predicate.empty('name')); }}", "testFindNewSyntax")).size());
			assertEquals("Advanced search() returns wrong result", 2, ((List)Scripting.evaluate(ctx, null, "${{ return $.search('Project', $.predicate.or($.predicate.empty('name'), $.predicate.equals('name', 'GROUP2'))); }}", "testFindNewSyntax")).size());
			assertEquals("Advanced search() returns wrong result", 3, ((List)Scripting.evaluate(ctx, null, "${{ return $.search('Project', $.predicate.contains('name2', 'e'), $.predicate.contains('name2', 'E'), $.predicate.contains('name2', 'E')); }}", "testFindNewSyntax")).size());
			assertEquals("Advanced search() returns wrong result", 2, ((List)Scripting.evaluate(ctx, null, "${{ return $.search('Project', $.predicate.and($.predicate.equals('age', $.predicate.range(0, 35)))); }}", "testFindNewSyntax")).size());
			assertEquals("Advanced search() returns wrong result", 1, ((List)Scripting.evaluate(ctx, null, "${{ return $.search('Project', $.predicate.equals('age', $.predicate.range(0, 35)), $.predicate.equals('name', 'grOUP2')); }}", "testFindNewSyntax")).size());
			assertEquals("Advanced search() returns wrong result", 1, ((List)Scripting.evaluate(ctx, null, "${{ return $.search('Project', $.predicate.and($.predicate.equals('age', $.predicate.range(0, 35)), $.predicate.equals('name', 'groUP2'))); }}", "testFindNewSyntax")).size());
			assertEquals("Advanced search() returns wrong result", 3, ((List)Scripting.evaluate(ctx, null, "${{ return $.search('Project', $.predicate.and($.predicate.contains('name2', 'E'))); }}", "testFindNewSyntax")).size());
			assertEquals("Advanced search() returns wrong result", 1, ((List)Scripting.evaluate(ctx, null, "${{ return $.search('Project', $.predicate.and($.predicate.equals('name', 'GROUP1'))); }}", "testFindNewSyntax")).size());
			assertEquals("Advanced search() returns wrong result", 1, ((List)Scripting.evaluate(ctx, null, "${{ return $.search('Project', $.predicate.and($.predicate.equals('name', 'GROUP1'), $.predicate.equals('name1', 'stRUCTR'))); }}", "testFindNewSyntax")).size());
			assertEquals("Advanced search() returns wrong result", 2, ((List)Scripting.evaluate(ctx, null, "${{ return $.search('Project', $.predicate.and($.predicate.equals('name1', 'sTRUCTR'), $.predicate.equals('name2', 'TEST'))); }}", "testFindNewSyntax")).size());
			assertEquals("Advanced search() returns wrong result", 0, ((List)Scripting.evaluate(ctx, null, "${{ return $.search('Project', $.predicate.and($.predicate.equals('name1', 'sTRUCTR'), $.predicate.equals('name2', 'sTRUCTR'))); }}", "testFindNewSyntax")).size());
			assertEquals("Advanced search() returns wrong result", 2, ((List)Scripting.evaluate(ctx, null, "${{ return $.search('Project', $.predicate.or($.predicate.equals('age', 22), $.predicate.equals('age', 44))); }}", "testFindNewSyntax")).size());
			assertEquals("Advanced search() returns wrong result", 2, ((List)Scripting.evaluate(ctx, null, "${{ return $.search('Project', $.predicate.and($.predicate.equals('name3', 'otHER'), $.predicate.or($.predicate.equals('age', 22), $.predicate.equals('age', 44)))); }}", "testFindNewSyntax")).size());
