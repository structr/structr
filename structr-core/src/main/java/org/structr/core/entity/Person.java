...
public class Person extends AbstractNode {
	...
	public static final View publicView = new View(Person.class, PropertyView.Public,
		id, name, salutation, firstName, middleNameOrInitial, lastName, twitterName, eMail, street, zipCode, city, state, country
	);

	public static final View uiView = new View(Person.class, PropertyView.Ui,
		id, name, salutation, firstName, middleNameOrInitial, lastName, twitterName, eMail, eMail2, phoneNumber1, phoneNumber2, faxNumber1, faxNumber2, street, zipCode, city, state, country, birthday, gender, newsletter
	);
