...
public class RuntimeEventLog {
	...
	private enum EventType {
		Transaction, Maintenance, Cron, ResourceAccess, FailedLogin, Login, Logout, Registration, Rest, Http, Csv, Javascript
	}
