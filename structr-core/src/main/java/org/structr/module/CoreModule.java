...
public class CoreModule implements StructrModule {
	...
	public void onLoad(final LicenseManager licenseManager) {
		...
		Functions.put(licensed, LicenseManager.Basic, "disable_cascading_delete", new DisableCascadingDeleteFunction());
		Functions.put(licensed, LicenseManager.Basic, "enable_cascading_delete", new EnableCascadingDeleteFunction());
